...
* \`pageSize\` (Optional) pageSize The number of clips to return in one page.
"""
playlistClips(playlistId: String!, cursor: Int = 1, pageSize: Int = 10): Clips
`;
const ClipQuery = `
"""
...
"""
clipTranscript(clipId: String!, format: String = "JSON", speakers: Boolean = true): Clip
`;
